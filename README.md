...
**[▶ Abrir o auditor no navegador](https://thiagolopes-ai.github.io/escala-clt/)** — cole a sua escala e receba as infrações. O arquivo não sai da sua máquina.
...
## A ferramenta que o gestor abre sem instalar nada

**[thiagolopes-ai.github.io/escala-clt](https://thiagolopes-ai.github.io/escala-clt/)**

Diagnóstico é o que vem antes de trocar de método, e ninguém troca de método antes de ver o próprio erro. Por isso o auditor tem uma porta que não exige saber Python: o gestor cola a escala do mês e recebe, na hora, cada infração com o artigo, a pessoa e o dia.
...
No cenário de referência, a capacidade que a lei permite usar é de 1.099 turnos para uma demanda de 1.080: folga de **1,8%**. É esse aperto que faz o método importar — e ele é impresso pelo próprio `comparar.py`, junto com o cenário:

```
Folga legal de efetivo (capacidade utilizável × demanda):
  12x36: 1099 × 1080 turnos = +1.8%
  44h:    110 ×  110 turnos = +0.0%
```

Repare no regime de 44 horas: folga zero. Cada turno administrativo do mês depende de que ninguém falte — e é exatamente de lá que vêm 11 dos 19 turnos que ficam descobertos.
...
|---|---|---|
| Programação por restrições (CP-SAT) | Heurística sem retrocesso com correção | Ela decide um turno por vez e nunca desfaz. Com folga de 1,8%, desfazer é o que fecha a escala |
