...
supervisor decide um turno de cada vez e nunca desfaz uma decisão anterior. O
solver considera as 1.190 decisões ao mesmo tempo e desfaz quantas precisar
para achar o conjunto que fecha. Num problema onde a folga de efetivo é de
1,7%, essa diferença é a diferença entre cobrir tudo e não cobrir.
